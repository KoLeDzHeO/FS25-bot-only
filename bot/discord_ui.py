...
def build_paused_embed() -> discord.Embed:
    """Создаёт embed, отображающий приостановку обновлений."""
    embed = discord.Embed(
        title="🛑 Сервер недоступен",
        description=(
            "Статистика временно приостановлена. "
            "Ожидается восстановление доступа к FTP-серверу."
        ),
        color=discord.Color.red(),
    )
    embed.set_footer(text="Обновление будет возобновлено автоматически.")
    return embed
